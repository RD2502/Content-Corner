                            ...
                            
                            {
                                userInfo && userInfo.role === 'admin' ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/post/create" />} icon={<PostAddIcon />}> Create post </MenuItem>
                                        <MenuItem component={<Link to="/updateuser" />} icon={<PersonIcon />}> UpdateProfile</MenuItem>
                                        <MenuItem component={<Link to="/users" />} icon={<PeopleIcon/>}> UsersList</MenuItem>
                                    </> :
                                    <>
                                        <MenuItem component={<Link to="/"/>} icon={<HomeIcon/>}>Home</MenuItem>
